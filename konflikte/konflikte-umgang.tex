...
Gerhard Schwarz~\cite{schwarz-konfliktmanagement} stellt folgende Strategien vor, mit Konflikten umzugehen (und sie optimalerweise zu lösen). Die Strategien sind grob geordnet von \glqq wenig bis sehr hilfreich\grqq\ (laut Schwarz).
...
\subsubsection{Nachteile}
\begin{itemize}
  \item die stärkere Person gewinnt und nicht die, die im Recht ist (falls überhaupt)
\end{itemize}
