...
Bei dieser Methode geht es vor allem darum, die Perspektiven der beteiligten Personen sichtbar zu machen und gemeinsam eine Lösung zu suchen.

Die Inhalte aus diesem Kapitel stammen aus dem Buch~\cite{difficult-conversations}.

\subsection{Stärken der Methode}
...
Jedes Konfliktgespräch besteht eigentlich aus drei unterschiedlichen Gesprächen:
...
\subsection{Die Schritte der Methode}

\begin{enumerate}
    \item Vorbereitung: die drei Gespräche für sich selbst durchgehen
    \item Ziel des Gesprächs überlegen: entscheiden, ob ich das Problem tatsächlich ansprechen möchte.
    \item die andere Person ansprechen und \fett{mit der dritten Geschichte beginnen}
    \item miteinander reden, um die beiden Geschichten aus der Sicht beider Personen austauschen (inklusive der Gefühle)
