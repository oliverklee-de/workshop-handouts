...
| Shortcut / Trick                          | Beschreibung                                                     |
|-------------------------------------------|------------------------------------------------------------------|
| Tab                                       | Vervollständigung für Shell-Befehle und Git                      |
| Cursor hoch / Cursor runter               | Durch die Kommando-History navigieren                            |
| Strg + R                                  | History durchsuchen                                              |
| `!$`                                      | Letztes Argument des vorherigen Befehls verwenden                |
