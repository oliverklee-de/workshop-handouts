...
\emph{Killer} sind üblicherweise eine kleine Minderheit in Spielen. Sie können allerdings das Spiel für die anderen zerstören, insbesondere für die \emph{Socializers}.
...
Amy Jo Kim hat aufbauend auf die Bartle-Taxonomie \emph{Kim’s Social Action Matrix}~\cite{kims-social-action-matrix} definiert, die auch auf Spiele anwendbar ist, für die die Bartle-Taxonomie nicht gut funktioniert, nämlich Casual-Spiele, soziale Spiele und edukative Spiele.
